using Minnow.DependencyInjection.Builders;
using System;
...
{
    public abstract class CustomAction<TServiceProvider, TMethodArgs, TFilterArgs>
        where TServiceProvider : ServiceProvider<TServiceProvider>
    {
        ...
        public abstract void Invoke(Object instance, TServiceProvider provider, TMethodArgs args);
        #endregion
    }

    public class CustomAction<T, TServiceProvider, TMethodArgs, TFilterArgs> : CustomAction<TServiceProvider, TMethodArgs, TFilterArgs>
        where T : class
        where TServiceProvider : ServiceProvider<TServiceProvider>
    {
        #region Delegates
        public delegate void MethodDelegate(T instance, TServiceProvider provider, TMethodArgs args);
        #endregion
        ...
        #region Helper Methods
        public override void Invoke(Object instance, TServiceProvider provider, TMethodArgs args)
        {
