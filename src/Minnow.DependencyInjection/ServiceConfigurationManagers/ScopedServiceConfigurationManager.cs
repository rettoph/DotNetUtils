...
{
    internal class ScopedServiceConfigurationManager<TServiceProvider> : TransientServiceConfigurationManager<TServiceProvider>
        where TServiceProvider : ServiceProvider<TServiceProvider>
    {
        #region Private Fields
        private Object _instance;
        public Func<Object> _getInstance;
        public Func<Action<Object, TServiceProvider, ServiceConfiguration<TServiceProvider>>, Int32, Object> _getInstanceWithCustomSetup;
        #endregion
        ...
        private Object BuildInstance(Action<Object, TServiceProvider, ServiceConfiguration<TServiceProvider>> customSetup, Int32 customSetupOrder)
        {
            _getInstance = this.ReturnInstance;
            _getInstanceWithCustomSetup = this.ReturnInstance;
        ...
        private Object ReturnInstance(Action<Object, TServiceProvider, ServiceConfiguration<TServiceProvider>> setup, Int32 setupOrder)
            => _instance;
        #endregion
